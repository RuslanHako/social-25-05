...
$sql = "SELECT id, title, content, image_url FROM posts ORDER BY created_at 
DESC";
...
alt="Post Image">';
        ...
        echo '<h2><a href="post.php?id=' . $row["id"] . '" style="color: 
#FFC000; text-decoration: none;">' . htmlspecialchars($row["title"]) .
            '</a></h2>';
